const CONFIG = {
nama: "binn marketplace", // Nama Store
profil: "https://files.catbox.moe/etyco1.jpeg", // Url Profil
banner: "https://files.catbox.moe/9gr5z6.jpeg", // Url Banner 
tentang: "binn marketplace adalah toko online terpercaya yang telah melayani ribuan pelanggan sejak 2020. Kami menyediakan berbagai produk digital untuk kebutuhan sehari-hari dengan kualitas terbaik dan harga terjangkau.\n\nKomitmen kami adalah memberikan pengalaman berbelanja yang menyenangkan dengan pelayanan terbaik, produk original, dan garansi resmi untuk semua produk yang kami jual.",
alamat: "Jl. randu agung 2 no 95 surabaya",
sosial_media: {
  email: "ytbintang4@gmail.com", // Email
  youtube: "@binnzzpreset", // YouTube Username 
  tiktok: "nasutionn_marganaa", // Tiktok Username 
  whatsapp: "085330105729", // WhatsApp Number 
  telegram: "binnprst" // Telegram Username
},
payment: {
  dana: "085330105729", // Payment Dana
  gopay: "085330105729", // Payment Gopay 
  ovo: "085330105729", // Payment Ovo 
            ...
            "APLIKASI PREMIUM": [
              {
                ...
                "variants": [
                  ...
                  { "name": "1tahun public", "price": 10000 },
                  { "name": "1bulan privat", "price": 8000 },
                  { "name": "1tahun privat", "price": 15000 },
              ...
              },
              {
                ...
                "icon": "fas fa-user-circle",
                "description": "kami menyediakan alight motion premium dengan harga ramah kantong/ dana pelajar super murah.",
                "variants": [
                  { "name": "1bulan privat", "price": 8000 },
                  { "name": "1tahun privat", "price": 15000 }
                ]
